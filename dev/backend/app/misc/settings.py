...
class Settings(BaseSettings):
	...
	oauth_github_auth_url: HttpUrl = HttpUrl('https://github.com/login/oauth/authorize')
	oauth_github_access_token_url: HttpUrl = HttpUrl('https://github.com/login/oauth/access_token')

	oauth_google_client_id: str
	oauth_google_client_secret: SecretStr
	oauth_google_auth_url: HttpUrl = HttpUrl('https://accounts.google.com/o/oauth2/v2/auth')
	oauth_google_access_token_url: HttpUrl = HttpUrl('https://oauth2.googleapis.com/token')
