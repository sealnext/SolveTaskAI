...
from app.schemas.llm_model import OpenAIModelName, AnthropicModelName
...
class AgentInput(BaseModel):
    ...
    model: SerializeAsAny[OpenAIModelName | AnthropicModelName] | None = Field(
        title="Model",
